...
import template from './sw-cms-el-gaisbock-switch-image-text.html.twig';
import './sw-cms-el-gaisbock-switch-image-text.scss';
...
export default {
    ...
    methods: {
        createdComponent() {
            this.initElementConfig('gaisbock-switch-image-text');
            this.initElementData('gaisbock-switch-image-text');
        },
        updateDemoValue() {
