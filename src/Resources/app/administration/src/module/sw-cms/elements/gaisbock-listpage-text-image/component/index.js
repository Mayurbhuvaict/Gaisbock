...
import template from './sw-cms-el-gaisbock-listpage-text-image.html.twig';
import './sw-cms-el-gaisbock-listpage-text-image.scss';
...
export default {
    ...
    methods: {
        createdComponent() {
            ...
            this.initElementData('gaisbock-listpage-text-image');
        },
        updateDemoValue() {
