...
import template from './sw-cms-el-gaisbock-image-titles-button.html.twig';
import './sw-cms-el-gaisbock-image-titles-button.scss';
...
export default {
    ...
    methods: {
        createdComponent() {
            ...
            this.initElementData('gaisbock-image-titles-button');
        },
        updateDemoValue() {
