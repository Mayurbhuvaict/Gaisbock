import template from './sw-cms-el-gaisbock-text-image-slider.html.twig';
const { Mixin, Filter } = Shopware;
import './sw-cms-el-gaisbock-text-image-slider.scss';
...
export default {
    ...
    methods: {
        createdComponent() {
            ...
            this.initElementData('gaisbock-text-image-slider');
