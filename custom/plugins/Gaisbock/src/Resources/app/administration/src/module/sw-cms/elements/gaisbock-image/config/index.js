import template from './sw-cms-el-config-gaisbock-image.html.twig';
import './sw-cms-el-config-gaisbock-image.scss';

const { Component, Mixin } = Shopware;

Component.register('sw-cms-el-config-gaisbock-image', {
    template,
