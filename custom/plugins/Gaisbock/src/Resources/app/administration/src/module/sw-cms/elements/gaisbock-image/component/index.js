...
import template from './sw-cms-el-gaisbock-image.html.twig';
import './sw-cms-el-gaisbock-image.scss';

const { Component, Mixin, Filter } = Shopware;

Component.register('sw-cms-el-gaisbock-image', {
    template,
    ...
    methods: {
        createdComponent() {
            this.initElementConfig('gaisbock-image');
            this.initElementData('gaisbock-image');
        },
    },
});
