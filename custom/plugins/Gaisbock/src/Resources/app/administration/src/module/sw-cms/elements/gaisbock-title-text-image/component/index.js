...
import template from './sw-cms-el-gaisbock-title-text-image.html.twig';
import './sw-cms-el-gaisbock-title-text-image.scss';
...
export default {
    ...
    methods: {
        createdComponent() {
            this.initElementConfig('gaisbock-title-text-image');
            this.initElementData('gaisbock-title-text-image');
        },
        updateDemoValue() {
