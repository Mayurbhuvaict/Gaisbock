...
namespace Gaisbock\Core\Content\Product\SalesChannel\Review;
...
#[Package('inventory')]
class GaisbockProductReviewSaveRoute extends AbstractProductReviewSaveRoute
{
    ...
    private function validate(DataBag $data, Context $context): void
    {
        ...
        $definition->add('name');
        $definition->add('title', new NotBlank());
