...
namespace Acris\CategoryCustomerGroup\Custom;
...
class CategoryCustomerGroupDefinition extends MappingEntityDefinition
{
    public const ENTITY_NAME = 'acris_category_customer_group';
