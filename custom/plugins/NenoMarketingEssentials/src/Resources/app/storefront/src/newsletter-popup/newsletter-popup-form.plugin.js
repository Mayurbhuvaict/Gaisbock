...
export default class NewsletterPopupForm extends Plugin {
    ...
    init() {
        ...
        this._errorContainer = this._popupParent.querySelector('.nme-newsletter-popup--error-container');
        this._captchaErrorContainer = this._popupParent.querySelector('.nme-newsletter-popup--captcha-error-container');
        ...
        try {
            this._httpClient.post(
                ...
                (response) => {
                    ...
                    const innerContent = this._popupParent.querySelector('.nme-newsletter-popup--content-inner');

                    const responseWrapper = this._popupParent.querySelector('.nme-newsletter-popup--response-wrapper');
                    const responseText = responseWrapper.querySelector('.nme-newsletter-popup--response-text');
