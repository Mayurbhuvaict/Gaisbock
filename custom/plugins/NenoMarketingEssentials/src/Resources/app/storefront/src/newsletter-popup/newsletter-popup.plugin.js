...
export default class NewsletterPopup extends Plugin {
    init() {
        ...
        const closeBtn = this.el.querySelector('.nme-newsletter-popup--close-btn');
        const nonSubscribeBtn = this.el.querySelector('.nme-newsletter-popup--non-subscribe-btn')
        const bgLayer = document.querySelector('.nme-newsletter-popup--bg-layer');
