...
class RegisterPopupEntitySubscriber implements EventSubscriberInterface
{
    ...
    {
        return [
            'neno_marketing_essentials_register_popup.written' => 'onDataWritten',
            'neno_marketing_essentials_register_popup.deleted' => 'onDataDeleted'
        ];
    }
