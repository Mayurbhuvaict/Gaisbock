...
namespace Acris\ProductCustomerGroup\Custom;
...
class ProductCustomerGroupDefinition extends MappingEntityDefinition
{
    public const ENTITY_NAME = 'acris_product_customer_group';
