...
namespace Pluszwei\FaqManager\Core\Content\Category\DataAbstractionLayer;
...
class CategoryBreadcrumbUpdater
{
    ...
    public function update(array $ids, Context $context): void
    {
        ...
        $query->from('pluszwei_faq_category', 'category');
    ...
    private function updateLanguage(array $ids, Context $context, array $all): void
    {
        ...
        $update = $this->connection->prepare('
            INSERT INTO `pluszwei_faq_category_translation` (`pluszwei_faq_category_id`, `pluszwei_faq_category_version_id`, `language_id`, `breadcrumb`, `created_at`)
